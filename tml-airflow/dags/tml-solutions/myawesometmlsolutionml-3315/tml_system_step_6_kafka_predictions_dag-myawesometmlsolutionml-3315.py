...
default_args = {
  ...
  'description' : 'A real-time Marine IoT monitoring platform for detecting environmental anomalies and analyzing ocean sensor data using AI-driven insights.',    # <<< *** Change as needed   
