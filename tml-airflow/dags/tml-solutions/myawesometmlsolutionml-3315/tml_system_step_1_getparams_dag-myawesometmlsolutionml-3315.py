...
default_args = {
 ...
 'solutionname': 'Marine IOT Device',   # <<< *** DO NOT MODIFY - THIS WILL BE AUTOMATICALLY UPDATED
 'solutiontitle': 'A real-time Marine IoT monitoring platform for detecting environmental anomalies and analyzing ocean sensor data using AI-driven insights.', # <<< *** Provide a descriptive title for your solution
 ...
 'description': 'This is aA real-time Marine IoT monitoring system designed to analyze ocean sensor data, detect environmental anomalies built by TSS',   # <<< *** Provide a description of your solution
 'HTTPADDR' : 'https://',
