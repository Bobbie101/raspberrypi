...
default_args = {
 ...
 'pgptcontainername' : 'maadsdocker/tml-privategpt-with-cpu-arm64-llama3-tools', #'maadsdocker/tml-privategpt-no-gpu-amd64',  # enter a valid container https://hub.docker.com/r/maadsdocker/tml-privategpt-no-gpu-amd64
