...
default_args = {
  'topic' : 'Marine IoT monitoring system',    # <<< *** Separate multiple topics by a comma - Viperviz will stream data from these topics to your browser
  'dashboardhtml': 'iot-failure-marinesystem.html', # <<< *** name of your dashboard html file  try: iot-failure-seneca.html
