...
default_args = {
 ...
 'solutionname': 'tml-multi-agenticai-iot-3f10-3315-3315',   # <<< *** DO NOT MODIFY - THIS WILL BE AUTOMATICALLY UPDATED
 'solutiontitle': 'Marine Sensor AI Monitoring Solution', # <<< *** Provide a descriptive title for your solution
 ...
 'description': 'A real-time marine sensor monitoring solution designed to detect temperature increases, shifts in underwater environmental conditions, and unusual biological activity for ocean observation and early anomaly detection.',   # <<< *** Provide a description of your solution
 'HTTPADDR' : 'https://',
 'COMPANYNAME' : 'Otics',       
