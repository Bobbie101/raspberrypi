...
default_args = {
 'owner' : 'Bobbie Williams', # <<< ********** You change as needed
 'companyname': 'Otics',  # <<< ********** You change as needed
  'myname' : 'Bobbie',  # <<< ********** You change as needed
  'myemail' : 'Bobbie@Bobbiew.com',  # <<< ********** You change as needed
  ...
  'description' : 'Topics to store marine sensor monitoring data and analysis results',      
}
