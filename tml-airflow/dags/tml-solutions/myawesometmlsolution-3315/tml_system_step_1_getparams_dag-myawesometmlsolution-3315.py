...
default_args = {
 ...
 'solutionname': 'myawesometmlsolution-3315',   # <<< *** DO NOT MODIFY - THIS WILL BE AUTOMATICALLY UPDATED
 'solutiontitle': 'Marine IOT System', # <<< *** Provide a descriptive title for your solution
 ...
 'description': 'A real-time Marine IoT monitoring platform for detecting environmental anomalies and analyzing ocean sensor data using AI-driven insights built by TSS',   # <<< *** Provide a description of your solution
 'HTTPADDR' : 'https://',
