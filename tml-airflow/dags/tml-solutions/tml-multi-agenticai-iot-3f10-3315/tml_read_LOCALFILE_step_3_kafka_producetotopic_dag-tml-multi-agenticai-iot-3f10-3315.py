...
default_args = {
  ...
  'producerid' : 'marine-sensor-solution',   # <<< *** Change as needed   
  'topics' : 'iot-raw-data', # *************** This is one of the topic you created in SYSTEM STEP 2
  'identifier' : 'Marine Sensor Monitoring for Temperature Shifts and Environmental Anomalies',   # <<< *** Change as needed   
  'inputfile' : '/rawdata/agenticone.json',  # <<< ***** replace ?  to input file name to read. NOTE this data file should be JSON messages per line and stored in the HOST folder mapped to /rawdata folder 
