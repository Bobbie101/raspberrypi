...
default_args = {
  'myname' : 'Bobbie Williams',   # <<< *** Change as needed      
  'enabletls': '1',   # <<< *** 1=connection is encrypted, 0=no encryption
  'microserviceid' : '', # <<< *** leave blank
  'producerid' : 'iotsolution',    # <<< *** Change as needed   
  'preprocess_data_topic' : 'iot-preprocess,iot-preprocess2', # << *** topic/data to use for training datasets - You created this in STEP 2
  'ml_data_topic' : 'ml-data', # topic to store the trained algorithms  - You created this in STEP 2
  'identifier' : 'Marine sensor monitoring for underwater temperature shifts and unusual environmental activity',    # <<< *** Change as needed   
  'companyname' : 'Otics', # <<< *** Change as needed      
  'myemail' : 'Bobbie@Bobbiew.com', # <<< *** Change as needed      
