...
default_args = {    
 'conf_project' : 'Marine Sensor AI Monitoring Solution',
 'conf_copyright' : '2026, Bobbie Williams',
 'conf_author' : 'Bobbie Williams',
 'conf_release' : '0.1',
 'conf_version' : '0.1.0',
...
def setupurls(projectname,producetype,sname):
    ...
    stepurl10="https://github.com/{}/{}/tree/main/tml-airflow/dags/tml-solutions/{}/tml_system_step_10_documentation_dag_tml-multi-agenticai-iot-3f10-3315-{}.py".format(os.environ['GITUSERNAME'],tsslogging.getrepo(),projectname,projectname)
